...
OPINION_PATTERNS = [
    ...
    r"\bi feel\b",
    r"\bi prefer\b",
    r"\bi (tried|tested|used|visited|experienced|noticed|found)\b",
    r"\bwe (tried|tested|used|visited|experienced|noticed|found)\b",
    r"\bhonestly\b",
    r"\bpersonally\b",
    r"\bin my experience\b",
    r"\bfor me\b",
    r"\bto me\b",
    r"\bi (love|loved|hate|hated|enjoy|enjoyed)\b",
    r"\bin my opinion\b",
    r"\bbeautiful\b",
    r"\bawful\b",
    r"\bmeaningless\b",
